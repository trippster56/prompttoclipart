...
const steps = [
  {
    ...
    description: 'Describe the clipart you want in natural language. Be specific about style, colors, and content.',
  },
  {
    id: '02',
    title: 'AI Generation',
    description: 'Our AI technology analyzes your prompt and creates multiple clipart options based on your description.',
  },
  {
    id: '03',
    title: 'Review & Edit',
    description: 'Preview your clipart options, make adjustments to your prompt if needed, or select the perfect image.',
  },
  {
    id: '04',
    title: 'Download & Use',
    description: 'Download your clipart in your preferred format and use it in your projects, presentations, or content.',
  },
];
