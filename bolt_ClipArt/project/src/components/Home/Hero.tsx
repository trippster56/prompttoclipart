          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              ...
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                Create stunning, unique clipart from simple text prompts using the power of AI. Perfect for presentations, social media, blogs, and more.
              </p>
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                ...
                <div className="mt-3 sm:mt-0 sm:ml-3">
                  <a
                    href="/explore"
                    className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-teal-700 bg-teal-100 hover:bg-teal-200 md:py-4 md:text-lg md:px-10 transition duration-150 ease-in-out"
                  >
                    Explore Gallery
                  </a>
                </div>
              ...
              <div className="mt-6 flex items-center">
                ...
                <p className="ml-2 text-sm text-gray-500">
                  Powered by ChatGPT Sora AI technology
                </p>
              </div>
            </div>
          </main>
