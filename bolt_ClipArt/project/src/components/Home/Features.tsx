...
import { Sparkles, ImagePlus, Download, Clock, Share2, Lock } from 'lucide-react';
...
const features = [
  ...
  },
  {
    ...
    description: 'Create unique, custom clipart for any need - presentations, websites, social media, and more.',
    icon: ImagePlus,
  },
  {
  ...
  },
  {
    ...
    description: 'Use your creations in commercial projects with our flexible licensing options.',
    icon: Lock,
  },
];
